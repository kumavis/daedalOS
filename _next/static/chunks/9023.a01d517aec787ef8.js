...
`,u=n(7459),p=n(26724),h=n(56758),g=n(25804),w=n(19682),x=n(30663),b=n(42362),f=n(34254),m=e=>{let{id:t}=e;const{icon:n,linkElement:m,url:v,processes:{[t]:k}}=(0,h.z)(),{prependFileToTitle:y}=(0,u.Z)(t),{url:S=""}=k||{},j=S||"https://www.google.com/webhp?igu=1",{canGoBack:$,canGoForward:C,history:F,moveHistory:Z,position:E}=(0,w.Z)(j,t),{exists:I,readFile:z}=(0,p.o)(),B=(0,s.useRef)(null),L=(0,s.useRef)(null),[R,T]=(0,s.useState)(!1),[G,A]=(0,s.useState)(""),D=e=>{Z(e),B.current&&(B.current.value=F[E+e])},H=(0,s.useRef)(""),P=(0,s.useCallback)((async e=>{const{contentWindow:i}=L.current||{};if(i?.location){const s=[".htm",".html"].includes((0,f.RT)(e))&&await I(e);if(T(!0),A(""),s&&A((await z(e)).toString()),n(t,g.Z.Browser.icon),!s){const s=await(0,f.Qv)(e);if(i.location.replace(s),s.startsWith(f.z8))y(`${e} - Google Search`);else{const{name:t=""}=r?.find((t=>{let{url:n}=t;return n===e}))||{};y(t)}if(e.startsWith("ipfs://"))n(t,"/System/Icons/Favicons/ipfs.webp");else{const e=new Image,i=`${new URL(s).origin}${o.Yg}`;e.addEventListener("error",(()=>{const{icon:e}=r?.find((e=>{let{url:t}=e;return t===s}))||{};e&&n(t,e)}),o.K7),e.addEventListener("load",(()=>n(t,i)),o.K7),e.src=i}}}}),[I,t,y,z,n]);return(0,s.useEffect)((()=>{k&&F[E]!==H.current&&(H.current=F[E],P(F[E]))}),[F,E,k,P]),(0,s.useEffect)((()=>{L?.current&&m(t,"peekElement",L.current)}),[t,m]),(0,i.jsxs)(d,{$hasSrcDoc:Boolean(G),children:[(0,i.jsxs)("nav",{children:[(0,i.jsxs)("div",{children:[(0,i.jsx)(x.Z,{disabled:!$,onClick:()=>D(-1),...(0,f.PS)("Click to go back"),children:(0,i.jsx)(c,{direction:"left"})}),(0,i.jsx)(x.Z,{disabled:!C,onClick:()=>D(1),...(0,f.PS)("Click to go forward"),children:(0,i.jsx)(c,{direction:"right"})}),(0,i.jsx)(x.Z,{disabled:R,onClick:()=>P(F[E]),...(0,f.PS)("Reload this page"),children:R?(0,i.jsx)(a,{}):(0,i.jsx)(l,{})})]}),(0,i.jsx)("input",{ref:B,defaultValue:j,enterKeyHint:"go",onFocusCapture:()=>B.current?.select(),onKeyDown:e=>{let{key:n}=e;B.current&&"Enter"===n&&(v(t,B.current.value),window.getSelection()?.removeAllRanges(),B.current.blur())},type:"text"})]}),(0,i.jsx)("nav",{children:r.map((e=>{let{name:n,icon:o,url:r}=e;return(0,i.jsx)(x.Z,{onClick:()=>{B.current&&(B.current.value=r),v(t,r)},...(0,f.PS)(`${n}\n${r}`),children:(0,i.jsx)(b.Z,{alt:n,imgSize:16,src:o})},n)}))}),(0,i.jsx)("iframe",{ref:L,onLoad:()=>T(!1),srcDoc:G||void 0,title:t,...o.v0})]})}},7459:function(e,t,n){var i=n(56758),o=n(25804),r=n(67294),s=n(64358);t.Z=e=>{const{title:t}=(0,i.z)(),[n]=e.split(s.CC),{title:c}=o.Z[n]||{};return{appendFileToTitle:(0,r.useCallback)(((n,i)=>{const o=n?` - ${n}${i?` ${s.xy}`:""}`:"";t(e,`${c}${o}`)}),[e,c,t]),prependFileToTitle:(0,r.useCallback)(((n,i)=>{const o=n?`${i?`${s.xy} `:""}${n} - `:"";t(e,`${o}${c}`)}),[e,c,t])}}},19682:function(e,t,n){var i=n(56758),o=n(67294);t.Z=(e,t)=>{const{url:n}=(0,i.z)(),[r,s]=(0,o.useState)(e),[c,l]=(0,o.useState)((()=>[e])),[a,d]=(0,o.useState)(0),u=(0,o.useCallback)((e=>{const i=a+e;d(i),s(c[i]),n(t,c[i])}),[n,c,t,a]);return(0,o.useEffect)((()=>{e!==r&&(d(a+1),s(e),l([...c.slice(0,a+1),e]))}),[r,c,a,e]),{canGoBack:a>0,canGoForward:a<c.length-1,currentUrl:r,history:c,moveHistory:u,position:a}}}}]);